...
// --------------- PUBLIC VARIABLES ---------------
	...
	public Button ShareStatsButton;
...
// --------------- START FUNCTION ---------------
	void Start() {
		...
		Button ShareStatsButtonClick = ShareStatsButton.GetComponent<Button>();
		...
		ShareStatsButtonClick.onClick.AddListener(ShareStatsButtonClicking);
	}
...
// ---------------------------------------- START: OTHER FUNCTIONS ----------------------------------------
	...
	public void ShareStatsButtonClicking() {
		StartCoroutine(FadeInOverlayShareStats());
	}
	...
	public IEnumerator FadeInOverlayShareStats() {
		float ElapsedTime = 0.0f;
		OverlayImage.enabled = true;
		OverlayImage.GetComponent<Image>().color = OverlayAlpha;
