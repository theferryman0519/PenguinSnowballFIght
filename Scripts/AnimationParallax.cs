...
public class AnimationParallax : MonoBehaviour {
...
// --------------- STATIC VARIABLES ---------------
	public static float NewSceneStartingPositionA;
	public static float NewSceneStartingPositionB;
	public static float NewSceneStartingPositionC;
	public static float NewSceneStartingPositionD;
	public static float NewSceneStartingPositionE;
...
// --------------- START FUNCTION ---------------
	void Start() {
		SkyStartingPositionA = SkyA.transform.position.x;
		SkyStartingPositionB = SkyB.transform.position.x;
		SkyStartingPositionC = SkyC.transform.position.x;
		SkyStartingPositionD = SkyD.transform.position.x;
		SkyStartingPositionE = SkyE.transform.position.x;
